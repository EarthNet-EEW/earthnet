...
See [`DESIGN.md`](DESIGN.md) for the full architecture. Wire format: [`PROTOCOL-v0.1-DRAFT.md`](PROTOCOL-v0.1-DRAFT.md) (current) and [`PROTOCOL-v0.2-DRAFT.md`](PROTOCOL-v0.2-DRAFT.md) (the multi-modal **Signal** envelope — the platform keystone). Operations: [`docs/OBSERVABILITY.md`](docs/OBSERVABILITY.md) · [`docs/DESIGN-multi-node-attestation.md`](docs/DESIGN-multi-node-attestation.md).
